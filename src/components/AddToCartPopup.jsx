  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-80">
        {!showThanks ? (
          <>
            <h3 className="text-xl font-semibold mb-4 text-center">Enter your Email to Complete the Purchase</h3>
            <p className="mb-4 text-center font-semibold">Product: {product.name}</p>
            <input
              type="email"
